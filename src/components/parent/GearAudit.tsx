// Removed unused useState to pass Vercel build
export default function GearAudit() {
  const gearItems = [
    ...
    { id: 3, name: "Fins", health: 95, sessions: 5, limit: 100 },
  ];
  ...
  return (
    <div className="animate-in slide-in-from-bottom-8 duration-700 space-y-10 pb-20 text-left text-white">
      <div>
        ...
        <p className="text-slate-400 text-sm font-bold tracking-widest mt-2 uppercase italic italic">Equipment Health Monitor</p>
      </div>
